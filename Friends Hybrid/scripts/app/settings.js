...
var appSettings = {
    ...
    everlive: {
        apiKey: 'QJgkfxf5WdknpBP6', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: '172fc14cd3d54c1cb375f569a6e7df1a',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: 'c24fbdf0-3cf8-11e5-8529-859fb940f79a',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
